{{-- use AppLayout Component located in app\View\Component\AppLayout.php wich use resources\views\layouts\app.blade.php view--}}
<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between">
            ...
            <a href="{{ route('posts.create') }}" class="bg-blue">ADD</a>
        </div>
    </x-slot>

    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-whiite overflow-hidden shadow-sm sm:rounded-lg">
